...
```bash
node scripts/slack-post.cjs BUILD "*FRONTEND-DEV — ACTIVATED*
...
```bash
node scripts/slack-post.cjs BUILD "*FRONTEND-DEV — WORK COMPLETE*
...
```bash
node scripts/slack-post.cjs ALERTS "*FRONTEND-DEV — BLOCKED*
...
6. Post to Slack using `node scripts/slack-post.cjs BUILD` with your completion summary.
