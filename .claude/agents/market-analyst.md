...
```bash
node scripts/discord-post.cjs BUSINESS "*MARKET-ANALYST — ACTIVATED*
...
```bash
node scripts/discord-post.cjs BUSINESS "*MARKET-ANALYST — WORK COMPLETE*
...
```bash
node scripts/discord-post.cjs ALERTS "*MARKET-ANALYST — BLOCKED*
