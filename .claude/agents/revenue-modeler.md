...
```bash
node scripts/slack-post.cjs BUSINESS "*REVENUE-MODELER — ACTIVATED*
...
```bash
node scripts/slack-post.cjs BUSINESS "*REVENUE-MODELER — WORK COMPLETE*
...
```bash
node scripts/slack-post.cjs ALERTS "*REVENUE-MODELER — BLOCKED*
