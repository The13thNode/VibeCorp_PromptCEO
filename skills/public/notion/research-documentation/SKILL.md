...
used_by: [market-analyst, business-analyst, product-manager]
---
...
- `skills/public/notion/knowledge-capture/SKILL.md` — For documenting discussions and insights
- `skills/public/notion/meeting-intelligence/SKILL.md` — For research-informed meeting prep
- `skills/public/notion/spec-to-implementation/SKILL.md` — For research-based implementation planning
