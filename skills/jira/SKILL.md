...
Ask the user for:
- **Project key** (e.g., "[JIRA_PROJECT_KEY]") - NEVER ASSUME
...
#### Working with Epics
1. **Find epics**: Use JQL: `issuetype = Epic AND project = [JIRA_PROJECT_KEY]`
...
{
  "link_type": "Blocks",
  "inward_issue_key": "[JIRA_PROJECT_KEY]-123",
  "outward_issue_key": "[JIRA_PROJECT_KEY]-456",
...
```json
{
  "issues": "[{\"project_key\":\"[JIRA_PROJECT_KEY]\",\"summary\":\"Task 1\",\"issue_type\":\"Task\"},{\"project_key\":\"[JIRA_PROJECT_KEY]\",\"summary\":\"Task 2\",\"issue_type\":\"Bug\"}]",
  "validate_only": false
}
```
